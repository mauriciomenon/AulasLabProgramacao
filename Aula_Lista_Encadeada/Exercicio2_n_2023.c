...
int main() {
    ...
    printf("Digite uma string (pressione Enter para encerrar a leitura):\n");

    // leitura da string caractere a caractere
    char c;
    while ((c = getchar()) != '\n') {
        xg.dado = c;
    ...
    // inserir o '\0' na lista encadeada
    xg.dado = '\0';
    insercaoFinal(pCabeca, xg);

    // impressão do texto como uma string
    printf("\nTexto digitado: ");
